...
```
$ docker image tag cblog davidsells/cblog
$ docker push davidsells/cblog
$ docker image tag cgateway davidsells/cgateway
$ docker push davidsells/cgateway
$ docker image tag cstore davidsells/cstore
$ docker push davidsells/cstore
```
...
```
$ kubectl get svc cgateway -n demo
```
